...
def shootRandom():
    ...
    if cleanMode == True:
        ...
        print(f"lasthits sind jetzt auf die von hitFields gestellt worden: hit fields 0{hitFields}")
        print(f"lasthits sind jetzt auf die von hitFields gestellt worden: last hits 0 {lastHits}")
        return shootLine()
...
def shootLine():
    ...
    print(f"line shotCount: {shotCount}")
    ...
    while shotCount > 0: # wieerhole für die anzahl der hits
        ...
        print(f"gibts ein line error?: {lineTry}")
...
def shootAI(shotData):
    ...
    if len(hitFields) > 0:
        ...
        print("ja nee start oder grooooooooooooooooooooooooßes problem")
